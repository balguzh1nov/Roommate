...
class MatchesNavBar: UIView {
    ...
    override init(frame: CGRect) {
        ...
        iconImageView.tintColor = #colorLiteral(red: 0.03529411765, green: 0.5176470588, blue: 0.8901960784, alpha: 1)
        let messagesLabel = UILabel(text: "Сообщения", font: .boldSystemFont(ofSize: 20), textColor: #colorLiteral(red: 0.03529411765, green: 0.5176470588, blue: 0.8901960784, alpha: 1), textAlignment: .center)
