...
//            print("Successfully saved message into firestore")
    ...
    fileprivate func saveToFromRecentMessages() {
        ...
        let data = ["text": customInputView.textView.text ?? "", "name": match.name, "surname": match.surname, "profileImageUrl": match.profileImageUrl, "timestamp": Timestamp(date: Date()), "uid": match.uid] as [String : Any]
...
//            print("Saved recent message")
        ...
        let toData = ["text": customInputView.textView.text ?? "", "name": currentUser.name ?? "", "surname": currentUser.surname ?? "", "profileImageUrl": currentUser.imageUrl1 ?? "", "timestamp": Timestamp(date: Date()), "uid": currentUserId] as [String : Any]
